  ...
  return (
    <Card className="group">
      <div className="relative h-44 w-full bg-slate-50 p-4">
        ...
        />
        <button className="absolute top-3 right-3 h-10 w-10 bg-white rounded-full shadow-md flex items-center justify-center text-brand-primary hover:bg-brand-primary hover:text-white transition-all active:scale-90">
      ...
      <div className="p-4 space-y-2">
        ...
        <div className="flex items-end justify-between pt-2">
          ...
          <Button size="sm" variant="ghost" className="h-10 w-10 p-0 rounded-full bg-brand-accent text-brand-primary">
